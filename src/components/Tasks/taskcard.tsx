  ...
  return (
    <>
      <div className="flex gap-5 p-2 -mt-4 ml-2">
        {/* CARD 1 */}
        <div className="w-[235px] h-[290px] bg-white rounded-3xl shadow-[0_4px_17px_rgba(0,0,0,0.20)] p-4">
          <div className="bg-[#D8A75B] h-20 rounded-2xl relative flex items-center justify-center gap-2 px-4 text-[#764B06] font-semibold text-[16px]">
            <Maximize2
          ...
          <div className="mt-2 text-center text-[13px]">
            ...
            <p className="text-[#7D5414] text-[12px] font-semibold">
              Start &nbsp; End
            </p>
          </div>

          <p className="text-center mt-1 text-[10px] text-gray-700 leading-tight">
            The team met to review progress on the IT project, discuss challenges,
            and assign next tasks.
          </p>

          <div className="mt-4 w-full bg-gray-200 h-4 rounded-full overflow-hidden">
            <div
              className="bg-[#D8A75B] h-4 flex items-center justify-center text-[10px] text-white font-semibold"
        ...
        {/* CARD 2 */}
        <div className="w-[235px] h-[290px] bg-white rounded-3xl shadow-[0_4px_17px_rgba(0,0,0,0.18)] p-4">
          <div className="bg-[#C5B6D4] h-20 rounded-2xl relative flex items-center justify-center gap-2 text-[#545256] font-semibold text-[16px] px-4">
            <Maximize2
          ...
          <div className="mt-2 text-center text-[13px]">
            <p>10:00 AM — 3:00 PM</p>
            <p className="text-[#726381] text-[12px] font-semibold">
              Start &nbsp; End
            </p>
          </div>
          ...
          <div className="mt-4 w-full bg-gray-200 h-4 rounded-full overflow-hidden">
            <div
              className="bg-[#C5B6D4] h-4 flex items-center justify-center text-[10px] text-white font-semibold"
        ...
        {/* CARD 3 */}
        <div className="w-[235px] h-[290px] bg-white rounded-3xl shadow-[0_4px_17px_rgba(0,0,0,0.18)] p-4">
          <div className="bg-[#D19A9C] h-20 rounded-2xl relative flex items-center justify-center gap-2 text-[#A34346] font-semibold text-[16px] px-4">
            <Maximize2
          ...
          <div className="mt-2 text-center text-[13px]">
            <p>10:00 AM — 3:00 PM</p>
            <p className="text-[#A34346] text-[12px] font-semibold">
              Start &nbsp; End
            </p>
          </div>
          ...
          <div className="mt-4 w-full bg-gray-200 h-4 rounded-full overflow-hidden">
            <div
              className="bg-[#D19A9C] h-4 flex items-center justify-center text-[10px] text-white font-semibold"
